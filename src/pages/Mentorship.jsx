...
import { ArrowLeft, Users, Calendar, Star, Loader2, UserPlus, CheckCircle2 } from 'lucide-react';
...
export default function Mentorship() {
  ...
  const handleConnect = async (mentor) => {
    ...
    try {
      ...
      setConnectedIds(prev => new Set([...prev, mentor.id]));
      toast.success(`Connection request sent to ${mentor.full_name || 'Mentor'}!`);
    } catch (err) {
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    disabled={connectingId === mentor.id || connectedIds.has(mentor.id)}
                  ...
                  >
                    ...
                    ) : connectedIds.has(mentor.id) ? (
                      <><CheckCircle2 size={16} className="text-emerald-500" /> Request Sent</>
                    ) : (
